...
@endif
    ...
    <div class="card-body">
          <form action="/bkd/pendidikan/{{$dosen->id}}/update" method="POST">
            {{csrf_field()}}
             <div class="form-group">
            <label for="exampleInputEmail1">Bidang</label>
            <input name="Bidang" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Bidang" value="{{$dosen->Bidang}}">
          </div>
